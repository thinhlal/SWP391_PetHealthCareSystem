...
router.post('/updateServiceInfo', verifyToken, serviceController.updateServiceInfo);
router.patch('/updateServiceStatus', verifyToken, serviceController.updateServiceStatus);
