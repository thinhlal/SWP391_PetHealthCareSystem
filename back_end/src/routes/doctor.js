...
router.get('/getBookingByID/:bookingID', verifyToken, doctorController.getBookingByID);
...
router.post('/savePetExamRecord', verifyToken, doctorController.savePetExamRecord);
