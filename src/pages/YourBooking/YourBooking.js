                      ...
                      <div className='card-detail-booking-confirm-booking'>
                        <div className='card-ID-booking'>
                          ...
                          <div className='price-cancel-rate-booking'>
                            ...
                            {booking.isCancel && booking.paymentsDetails[0].paymentMethod ===
                              'PAYPAL' && booking.isRefund ? <div className='status-cancel'>Refunded</div>
                              : booking.isCancel && booking.paymentsDetails[0].paymentMethod ===
                                'PAYPAL' && !booking.isRefund ? <div className='status-cancel'>...Processing refund</div>
