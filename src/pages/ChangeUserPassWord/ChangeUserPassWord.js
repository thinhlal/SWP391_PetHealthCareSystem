    ...
    <div className='main-change-user-password-container'>
      ...
      <div className="ChangeUserPassword-container container-xl px-4 mt-4">
        <nav className="ChangeUserPassword-nav nav nav-borders">
          <a className="ChangeUserPassword-nav-link nav-link ms-0" href="/user-profile">Profile</a>
          <a className="ChangeUserPassword-nav-link nav-link active" href="/change-user-password">Security</a>
        </nav>
        <hr className="ChangeUserPassword-hr mt-0 mb-4" />
        <div className="row">
          <div className="col-lg-8">
            <div className="ChangeUserPassword-card card mb-4">
              <div className="ChangeUserPassword-card-header card-header">Change Password</div>
          ...
          <div className="col-lg-4">
            <div className="ChangeUserPassword-card card mb-4">
              <div className="ChangeUserPassword-card-header card-header">Delete Account</div>
              <div className="ChangeUserPassword-card-body card-body">
