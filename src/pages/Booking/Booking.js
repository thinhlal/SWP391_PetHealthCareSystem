...
const Booking = () => {
    ...
    const generateDefaultSlots = () => {
        ...
        for (let current = new Date(start); current < end; current = new Date(current.getTime() + 60 * 60 * 1000)) {
            ...
            slots.push({ startTime: new Date(current), endTime: new Date(next), isBooked: false });
        }
        return slots;
    };
            ...
            <div className="div row">
                ...
                <div className="main-booking-menu">
                    ...
                    <div className="select-booking">
                        ...
                        <div className="select-booking_info">
                            ...
                            <div className="select_Doctors">
                                ...
                                <div className="select_Booking">
                                    <select name="doctors" className="select_Info" onChange={handleDoctorChange}>
                    ...
                    <div className="booking-menu">
                        {isDayOff ? (
                            <div className="day-off-message">The selected doctor is off on this day.</div>
                        ) : (
                            availableSlots.length === 0 ? (
                                <div className="no-slots-message">No available slots for this date.</div>
                            ) : (
