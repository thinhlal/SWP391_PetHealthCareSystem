...
function AdminServices() {
    ...
    const handleFormSubmit = () => {
        ...
        if (Object.values(newErrors).every(error => error === '') &&
            ...
            const newServiceData = { ...newService, id: servicesData.length + 1, services_id: newId };
            setServicesData([...servicesData, newServiceData]);
            setNewService({ services_name: '', describe: '', price: '$', status: 'Enable' });
    ...
    const handleUpdateFormSubmit = () => {
        ...
        if (Object.values(newErrors).every(error => error === '') &&
            ...
            setEditService({ id: null, services_id: '', services_name: '', describe: '', price: '', status: '' });
