              ...
              <div className="main-login-account">
                <div className="overlap-group">
                  ...
                  <div className="form-login-account">
                    ...
                    <img className="cat-img" src={catImage} alt="Cat" />
                    </span>
                    <div className="form-login-right-side">
                    <img className="logo-img" src={logo} alt="Logo" />
                      <div className="main-title">
                        <p className="main-title-text">Welcome to Pet Health Care</p>
                      </div>
                      <div className="form-send-login">
                        
                        <div className="input-user">
                          <input className="field-input-login" placeholder="Enter Username or Email." type="email" />
                        </div>
                        
                        <div className="input-password">
                          <input className="field-input-login" placeholder="Enter Password." type="password" />
                        </div>
                        <a  href="/">
                          <div className="text-button-forgot-password">Forgot password?</div>
                        </a>
