          ...
          <div className='vet-picture-wrapper'>
            ...
            <div className='vet-picture-content'>
              ...
              <ul>
                <li>
                  <strong>
                    Dental - Maxillofacial System Hanoi Medical University
                  </strong>
                </li>
              </ul>
          ...
          <div className='content-vet'>
            <div className='content-list-vet'>
              <div className='text-vet'>
                <div className='vet-p'>
                  Known not only as one of the leading experts in the field of
                  orthodontics in Vietnam, Dr. Pham Hong Duc is also loved by
                  everyone for his friendliness, dedication and enthusiasm.
                </div>
                <div className='vet-p'>
                  ✓ Dr. Minh is rated by Invisalign as the TOP 1 doctor in
                  Southeast Asia and TOP 1 in terms of experience and expertise
                  in Vietnam.
                </div>
                <div className='vet-p'>
                  ✓ The only doctor in Vietnam to achieve Black Diamond rank for
                  2 consecutive years
                </div>
              </div>
            </div>
            ...
            <div className='content-list-vet'>
              <div className='text-vet'>
                <div className='vet-p'>
                  ✓ 1 of 3 doctors using the Damon automatic braces system most
                  successfully in Vietnam
                </div>
                <div className='vet-p'>
                  ✓ Translator of famous orthodontic books such as 1001 clinical
                  tips in orthodontics (2015), Clinical cases in orthodontics
                  (2015), Biomechanics in orthodontics (2016),...{' '}
                </div>
                <div className='vet-p'>
                  ✓ Doctor Duc has experience in treating more than 6,500
                  orthodontic cases, and is considered one of the doctors with
                  the largest number of orthodontic patients in Hanoi.{' '}
                </div>
                <div className='vet-p'>
                  ✓ Be the first person to bring the F.A.C.E Braces Without
                  Extraction method from abroad to apply in Vietnam, helping to
                  minimize tooth extraction even without tooth extraction while
                  still bringing the highest treatment effectiveness.{' '}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='content-vet'>
            <div className='content-list-vet'>
              <div className='text-vet'>
                ...
                <div className='vet-p'>
                  ✓ Dr. Tung is rated by Invisalign as the TOP 1 doctor in
                  Southeast Asia and TOP 1 in terms of experience and expertise
                  in Vietnam.
                </div>
                <div className='vet-p'>
            ...
            <div className='content-list-vet'>
              <div className='text-vet'>
                <div className='vet-p'>
                  ✓ 1 in 3 doctors using the Damon automatic braces system most
                  successfully in Vietnam{' '}
                </div>
                <div className='vet-p'>
                  ✓ Translator of famous orthodontic books such as 1001 clinical
          ...
          <div className='content-vet'>
            <div className='content-list-vet'>
              <div className='text-vet'>
                ...
                <div className='vet-p'>
                  ✓ Dr. Dat is rated by Invisalign as the TOP 1 doctor in
                  Southeast Asia and TOP 1 in terms of experience and expertise
                  in Vietnam.
                </div>
                <div className='vet-p'>
          ...
          <div className='content-vet'>
            <div className='content-list-vet'>
              <div className='text-vet'>
                ...
                <div className='vet-p'>
                  ✓ Dr. Duong is rated by Invisalign as the TOP 1 doctor in
                  Southeast Asia and TOP 1 in terms of experience and expertise
                  in Vietnam.
                </div>
                <div className='vet-p'>
          ...
          <div className='content-vet'>
            <div className='content-list-vet'>
              <div className='text-vet'>
                ...
                <div className='vet-p'>
                  ✓ Dr. Thinh is rated by Invisalign as the TOP 1 doctor in
                  Southeast Asia and TOP 1 in terms of experience and expertise
                  in Vietnam.
                </div>
                <div className='vet-p'>
          ...
          <div className='content-vet'>
            <div className='content-list-vet'>
              <div className='text-vet'>
                ...
                <div className='vet-p'>
                  ✓ Dr. Phat is rated by Invisalign as the TOP 1 doctor in
                  Southeast Asia and TOP 1 in terms of experience and expertise
                  in Vietnam.
                </div>
                <div className='vet-p'>
