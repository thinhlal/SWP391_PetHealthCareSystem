...
import { Modal, Button, Tabs, Tab, Dropdown, DropdownButton, Form } from 'react-bootstrap';
...
const DoctorSchedule = () => {
  ...
  return (
    <div className="manage-doctor-container">
      ...
      <DropdownButton id="dropdown-basic-button" title={selectedDoctor ? selectedDoctor.name : 'Select Doctor'}>
        {doctors.map((doctor) => (
          <Dropdown.Item key={doctor.doctorID} onClick={() => handleDoctorSelect(doctor)}>
            {doctor.name}
          </Dropdown.Item>
        ))}
      </DropdownButton>
          ...
          {availableSlots.length > 0 ? (
            <div className="slots-list">
              {availableSlots.map((slot, index) => (
                <div key={index} className={`slot-item ${slot.isBooked ? 'booked' : ''}`} onClick={() => handleSlotClick(slot)}>
                  <div>
                  ...
                  <div className="grid-container">
                    ...
                    <div className="content-modal-manage-booking">
                      ...
                      <div className="reason-manage-booking">
                        ...
                        <small>{modalBookingDetails.petDetails[0].petType}</small>
                      </div>
                      <div className="reason-manage-booking">
                      ...
                      <div className="reason-manage-booking">
                        ...
                        <small>{modalBookingDetails.petDetails[0].gender}</small>
                      </div>
                    </div>
                  </div>
                </Tab>
                <Tab eventKey="service" title="Service">
                  <div className="grid-container">
                    <div className="content-modal-manage-booking">
                      ...
                      {modalBookingDetails.servicesInBooking.map((service, index) => (
                    ...
                    <div className="content-modal-manage-booking">
                      ...
                      <div className="reason-manage-booking">
                        ...
                        <small>{modalBookingDetails.paymentsDetails[0].date.split('T')[0]}</small>
                      </div>
                      {modalBookingDetails?.dateCancelBook && (
                        <div className="reason-manage-booking">
                          <small className="title-reason-manage-booking">Date Cancel:&nbsp;</small>
                          <small>{modalBookingDetails?.dateCancelBook?.split('T')[0]}</small>
                        </div>
                      )}
                      <div className="reason-manage-booking">
                        <small className="title-reason-manage-booking">Date Booking:&nbsp;</small>
                        <small>{modalBookingDetails.dateBook.split('T')[0]}</small>
                      </div>
                      {modalBookingDetails.isRefund &&
                        calculateDateLeft(modalBookingDetails.dateCancelBook, modalBookingDetails.dateBook) >= 3 ? (
                        <div className="reason-manage-booking">
                          <small className="title-reason-manage-booking">Refund price:&nbsp;</small>
                      ...
                      <div className="reason-manage-booking">
                        ...
                        <small>
                          {modalBookingDetails.paymentsDetails[0].isCancelPayment ? (
                            <span>Cancelled</span>
                          ) : modalBookingDetails.paymentsDetails[0].isSuccess === false ? (
                            <span>Not paid</span>
                          ) : (
                      ...
                      <div className="reason-manage-booking">
                        ...
                        <small>
                          {modalBookingDetails.paymentsDetails[0].paymentMethod === 'PAYPAL' ? (
                            <span>Online</span>
                          ) : (
