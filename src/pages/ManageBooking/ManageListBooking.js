...
function ManageListBooking() {
    ...
    const handleOpenModal = (booking) => {
        ...
        const serviceDetails = selectedServices.map(serviceName => {
            const service = availableServices.find(service => service.name === serviceName);
                    ...
                    <div className='manage-booking-main-content'>
                        <div className='main-content-header'>
                            <div className='main-content-header-search'>
                                <div className='main-content-header-search-title'>List of Booking</div>
                            ...
                            <div className='main-content-header-add-booking'>
                                <button type='button' className='booking-btn-add' data-bs-toggle='modal' data-bs-target='#exampleModal'>Add Booking</button>
                                                            ...
                                                            <div className='modal-body-section-doctor-date'>
                                                                ...
                                                                <div id='veterinarian'>
                                                                    {findAvailableDoctor(selectedDate, selectedTimeSlot.startTime, selectedTimeSlot.endTime)
                                                                        ...
                                                                        : <div className='choose-Doctor-Not-Found'>No Doctors Found</div>
                                                                    }
                                                                </div>
                            ...
                            <div className='main-content-list-body-wrapper'>
                                {allBookings.map(booking => (
                                    <div className='content-list-body-info' key={booking.bookingID}>
                                        ...
                                        <div className='content-list-body-value'>{truncateText(booking.name)}</div>
                                        <div className='content-list-body-value'>{truncateText(booking.petType)}</div>
                                        <div className='content-list-body-value'>{truncateText(booking.service)}</div>
                                                    ...
                                                    <div className='modal-body'>
                                                        {findAvailableDoctor(booking.day, booking.startTime, booking.endTime)
                                                            ? findAvailableDoctor(booking.day, booking.startTime, booking.endTime).map((doctor, index) => {
                                                                return (
                                                                    <div className='choose-Doctor-wrapper' key={doctor.id}>
                                                            ...
                                                            : <div className='choose-Doctor-Not-Found'>No Doctors Found In This Time</div>}
                                                    </div>
                                                    <div className='modal-footer'>
                                        ...
                                        {/* Payment Button */}
                                        <div className='content-list-body-value'>
                                            <button type='button' className='btn btn-success' data-bs-toggle='modal' data-bs-target={`#paymentModal-${booking.bookingID}`} onClick={() => handleOpenModal(booking)}>Payment</button>
                                        </div>
                                                    ...
                                                    <div className='modal-body-manage-booking'>
                                                        <div className='main-modal-content-manage-booking'>
                                                            ...
                                                            <div className='grid-container'>
                                                                ...
                                                                <div className='content-modal-manage-booking'>
                                                                    <div className='reason-manage-booking'>
                                                                        <span className='font-weight-bold'>Service Information</span>
                                                                    </div>
                                                                    <div className='reason-manage-booking'>
                                                                        <small className='title-reason-manage-booking'>Service:&nbsp;</small>
                                                                        <small>{Array.isArray(selectedBooking.services) ? selectedBooking.services.map(service => service.name).join(', ') : ''}</small>
                                                                    </div>
                                                                </div>
