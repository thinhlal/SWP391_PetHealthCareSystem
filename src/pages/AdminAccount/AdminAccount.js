...
function AdminAccount() {
  ...
  const [accountData, setAccountData] = useState([
    { id: 1, account_id: 'A00001', status: 'Disable', user_name: 'leslie123', name: 'Leslie', email: 'leslie14@gmail.com', phoneNum: '0888888888', role: 'Veterinarian' },
    { id: 2, account_id: 'A00002', status: 'Disable', user_name: 'ronaldo123', name: 'Ronal Đỗ', email: 'thichpen12@gmail.com', phoneNum: '0777777777', role: 'Staff' },
    { id: 3, account_id: 'A00003', status: 'Disable', user_name: 'messi123', name: 'Pessi', email: 'thichvuotrau2@gmail.com', phoneNum: '0101010100', role: 'Customer' },
    { id: 4, account_id: 'A00004', status: 'Disable', user_name: 'victoria123', name: 'Victoria', email: 'victoriasecret13@gmail.com', phoneNum: '0778774546', role: 'Customer' },
    { id: 5, account_id: 'A00005', status: 'Disable', user_name: 'john123', name: 'John', email: 'johnydog143@gmail.com', phoneNum: '0777123454', role: 'Admin' },
  ]);
  ...
  const filteredAccountData = accountData.filter(account => {
    ...
    const matchesSearch = search === '' || account.user_name.toLowerCase().includes(search.toLowerCase());
          ...
          <div className='Admin-Account-Main col-md-10'>
            ...
            <div className='Admin-Account-Main-Table-Wrapper'>
              <div className='Admin-Account-Main-Table'>
                <div className='Admin-Account-Main-Table-Title'> Account List </div>
                <div className='Admin-Account-Main-Table-Title-Text'> Account Information </div>
                <div className='Admin-Account-Main-Filter'>
                  ...
                  <div className='Admin-Account-Select-Role'>
                    ...
                    Select role:
                    <select className='Admin-Account-Select-Filter' name='role' onChange={handleRoleFilterChange} value={roleFilter}>
                      <option>All</option>
                      ...
                      <div className='modal-dialog'>
                        <div className='modal-content'>
                          <div className='modal-header'>
                            <h1 className='modal-title fs-5' id='exampleModalLabelEdit'> Add Account </h1>
                            <button type='button' className='btn-close' data-bs-dismiss='modal' aria-label='Close'></button>
                          </div>
                          <div className='modal-body'>
                            <div className='Admin-Account-modal-add-account'>
                              <div className='Admin-Account-modal-title-name'> User name </div>

                              <label className='Admin-Account-modal-add'> User name: </label>
                              <input className='Admin-Account-input' placeholder='Username/Email' />
                            </div>

                            <div className='Admin-Account-modal-add-account'>
                              <div className='Admin-Account-modal-title-name'> Password </div>
                              <label className='Admin-Account-modal-add'> Password: </label>
                              <input className='Admin-Account-input' type='password' placeholder='Password' />
                              <div className='Admin-Account-input-confirm'>
                                <label className='Admin-Account-modal-add'> Confirm password: </label>
                                <input className='Admin-Account-input' type='password' placeholder='Confirm password' />
                              </div>
                            </div>

                            <div className='Admin-Account-modal-add-account'>
                              <div className='Admin-Account-modal-title-name'> Name </div>
                              <label className='Admin-Account-modal-add'> Name: </label>
                              <input className='Admin-Account-input' placeholder='Name' />
                            </div>
                            <div className='Admin-Account-modal-add-account'>
                              <div className='Admin-Account-modal-title-name'> Role </div>

                              <label className='Admin-Account-modal-add'> Role: </label>
                ...
                <div className='Admin-Account-Main-Table-Header'>
                  ...
                  <div className='Admin-Account-Main-Table-Header-Title'> User name </div>
                  <div className='Admin-Account-Main-Table-Header-Title'> Role </div>
                  <div className='Admin-Account-Main-Table-Header-Title'> Status </div>
                  <div className='Admin-Account-Main-Table-Header-Title-Btn'> Action </div>
                </div>

                {filteredAccountData.map(item => (
                  <div className='Admin-Account-Main-Table-Content-Row-Wrapper' key={item.id}>
                    <div className='Admin-Account-Main-Table-Content-Row'> {item.account_id} </div>
                    <div className='Admin-Account-Main-Table-Content-Row'> {item.user_name} </div>
                    <div className='Admin-Account-Main-Table-Content-Row'> {item.role} </div>
                    <div className='Admin-Account-Main-Table-Content-Row'> {item.status} </div>
                    <div className='Admin-Account-Main-Table-Content-Row'>
                      <span className='Admin-Account-Main-Table-Content-Btn_Wrapper'>
                        ...
                        {/* Modal Edit */}
                        <div className='modal fade' id={`exampleModalEdit-${item.id}`} tabIndex='-1' aria-labelledby='exampleModalLabelEdit' aria-hidden='true'>
                          <div className='modal-dialog'>
                            <div className='modal-content'>
                              <div className='modal-header'>
                              ...
                              <div className='modal-body'>
                                <div className='Admin-Account-modal-update'>
                                  ...
                                  <div className='Admin-Account-modal-update-old'>
                                    <div className='Admin-Account-modal-initials'> Old name: </div>
                                    {currentAccount?.name}
                                  </div>
                                  <label className='Admin-Account-modal-update-new'> New name: </label>
                                  <input className='Admin-Account-input' placeholder='Username/Email' />
                                </div>
                                <div className='Admin-Account-modal-update'>
                                  <div className='Admin-Account-modal-title'> Email </div>
                                  <div className='Admin-Account-modal-update-old'>
                                    <div className='Admin-Account-modal-initials'> Old email: </div>
                                    {currentAccount?.email}
                                  </div>
                                  <label className='Admin-Account-modal-update-new'> New email: </label>
                                  <input className='Admin-Account-input' type='email' placeholder='Example@gmail.com' />
                                </div>
                                <div className='Admin-Account-modal-update'>
                                  <div className='Admin-Account-modal-title'> Phone </div>
                                  <div className='Admin-Account-modal-update-old'>
                                    <div className='Admin-Account-modal-initials'> Old phone number: </div>
                                    {currentAccount?.phoneNum}
                                  </div>
                                  <label className='Admin-Account-modal-update-new'> New phone number: </label>
                                  <input className='Admin-Account-input' placeholder='Phone number' />
                                </div>

                                <div className='Admin-Account-modal-update'>
                                  <div className='Admin-Account-modal-title'> Role </div>
                                  <div className='Admin-Account-modal-update-old'>
                                    <div className='Admin-Account-modal-initials'> Old role: </div>
                                    {currentAccount?.role}
                                  </div>
                                  <label className='Admin-Account-modal-initials'> New role: </label>
                                  <select className='Admin-Account-input-role'>
                                    <option>Customer</option>
                                    <option>Veterinarian</option>
                                    <option>Staff</option>
                                ...
                                <div className='Admin-Account-modal-update'>
                                  <div className='Admin-Account-modal-title'> Status </div>
                                  <div className='Admin-Account-modal-title-radio' > 
                                    <div className='Admin-Account-modal-title-radio-Enable' >
                                      <input type='radio' name='status' value='Enable' onChange={handleStatusChange} checked={selectedStatus === 'Enable'} />
                                      <label> Enable </label>
                                    </div>
                                    <div>
                                      <input type='radio' name='status' value='Disable' onChange={handleStatusChange} checked={selectedStatus === 'Disable'} />
                                      <label> Disable </label>
                                    </div>
                                  </div>
                                </div>
                      ...
                      <span className='Admin-Account-Main-Table-Content-Btn_Wrapper'>
                        <button type='button' className='Admin-Account-Main-Table-Content-Btn' data-bs-toggle='modal' data-bs-target={`#exampleModalMore-${item.id}`}>
                          <MoreVertOutlinedIcon sx={{ color: green[400] }} />
                        </button>
                        {/* Modal More */}
                        <div className='modal fade' id={`exampleModalMore-${item.id}`} tabIndex='-1' aria-labelledby='exampleModalLabelMore' aria-hidden='true'>
                          <div className='modal-dialog'>
                            <div className='modal-content'>
                              <div className='modal-header'>
                              ...
                              <div className='modal-body'>
                                <div className='Admin-Account-modal-more'>
                                  <div className='Admin-Account-modal-more-title'> Account ID: </div>
                                  {item.account_id}
                                </div>
                                <div className='Admin-Account-modal-more'>
                                  <div className='Admin-Account-modal-more-title'> Name: </div>
                                  {item.name}
                                </div>
                                <div className='Admin-Account-modal-more'>
                                  <div className='Admin-Account-modal-more-title'> User name: </div>
                                  {item.user_name}
                                </div>
                                <div className='Admin-Account-modal-more'>
                                  <div className='Admin-Account-modal-more-title'> Email: </div>
                                  {item.email}
                                </div>
                                <div className='Admin-Account-modal-more'>
                                  <div className='Admin-Account-modal-more-title'> Phone number: </div>
                                  {item.phoneNum}
                                </div>
                                <div className='Admin-Account-modal-more'>
                                  <div className='Admin-Account-modal-more-title'> Role: </div>
                                  {item.role}
                                </div>
                              </div>
                              <div className='modal-footer'>
