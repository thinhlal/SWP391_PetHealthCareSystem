...
import logo_3 from './img/img_Home/651dfce9820f55d331f420e6-pet-health-1-3.png'
import footer_Sheep from './img/img_Home/footer-shape02-1.png'
function Footer() {
    return (
        <div className="main-footer">
            <div className="main-footer_Info">
                <div className="main-footer_Info_Desc">
                    <img alt="" className="main-footer_logo" src={logo_3} />
